...
export function Sidebar() {
  return (
    <aside className="w-[109px] bg-[#1D1D41] flex flex-col items-center gap-[241px] py-[58px] max-sm:hidden">
      <div className="flex flex-col items-center gap-[42px]">
        <img
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/e55b90c86bb489df9a95c7c97367199bbef7be62"
          alt="Profile"
          className="w-[50px] h-[50px] rounded-[112.5px]"
        />
        <div>
          <svg
            width="61"
            ...
            className="flex h-[57px] p-[16px_15px] justify-center items-center gap-[10px] w-[61px] rounded-[8px] bg-[#6359E9]"
          >
            <rect width="61" height="57" rx="8" fill="#6359E9"></rect>
            <path
        ...
        <nav className="flex flex-col items-center gap-6">
          <button aria-label="Analytics" className="focus:outline-none">
            <svg
              width="25"
              height="24"
              viewBox="0 0 25 24"
          ...
          <button aria-label="Wallet" className="focus:outline-none">
            <svg
              width="25"
              height="24"
              viewBox="0 0 25 24"
          ...
          <button aria-label="Security" className="focus:outline-none">
            <svg
              width="25"
              height="24"
              viewBox="0 0 25 24"
          ...
          <button aria-label="Dark Mode" className="focus:outline-none">
            <svg
              width="25"
              height="24"
              viewBox="0 0 25 24"
      ...
      <div>
        ...
        >
          <circle cx="30.5" cy="30" r="30" fill="#B0F6FF"></circle>
          <mask
            id="mask0_12_520"
            ...
            height="60"
          >
            <circle cx="30.5" cy="30" r="30" fill="#D9D9D9"></circle>
          </mask>
          <g mask="url(#mask0_12_520)">
            <path d="M-12.5 5H72.5V61H-12.5V5Z" fill="url(#pattern0_12_520)"></path>
          </g>
          <defs>
            <pattern
              id="pattern0_12_520"
              ...
              height="1"
            >
              <use xlinkHref="#image0_12_520" transform="scale(0.00617284 0.00898079)"></use>
            </pattern>
          </defs>
        </svg>
      </div>
