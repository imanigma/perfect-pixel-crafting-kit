    ...
    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      <div className="space-y-6">
        <div className="flex flex-col space-y-1.5">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight">Time-Travel Investment Dashboard</h1>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-4">
            <TabsList className="md:w-auto w-full">
              <TabsTrigger value="scenario" className="flex-1 md:flex-none">
                <Calendar className="mr-2 h-4 w-4" />
                <span className="hidden sm:inline">Scenario</span> Selector
              </TabsTrigger>
              <TabsTrigger value="timeline" className="flex-1 md:flex-none">
                <History className="mr-2 h-4 w-4" />
                <span className="hidden sm:inline">Timeline</span> Explorer
              </TabsTrigger>
              <TabsTrigger value="realities" className="flex-1 md:flex-none">
                <GitCompareArrows className="mr-2 h-4 w-4" />
                <span className="hidden sm:inline">Alternate</span> Realities
              </TabsTrigger>
            </TabsList>
          ...
          <TabsContent value="scenario" className="space-y-6">
            <Card className="tr-card overflow-hidden">
              <CardHeader className="bg-card/50 backdrop-blur-sm p-4 sm:p-6">
            ...
            {simulationStarted && activeTab === "scenario" && (
              <Card className="tr-card overflow-hidden">
                ...
                <CardFooter className="bg-card/50 backdrop-blur-sm border-t border-border/40 p-4 sm:px-6">
